...
public class URLsEndpoints {
    ...
    private static final String HACKER_NEWS = "https://newsapi.org/v1/articles?source=hacker-news&apiKey=784c4d2b3ee54046b64d1e17de539247";
...
//    private static final String THE_NEXT_WEB = "https://newsapi.org/v1/articles?source=the-next-web&apiKey=766c6927e4f14b00ad566899afbab0e5";
    ...
    public static final List<String> ENDPOINTS_LIST = asList(HACKER_NEWS);
