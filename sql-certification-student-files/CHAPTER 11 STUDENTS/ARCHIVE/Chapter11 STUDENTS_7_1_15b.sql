...
alter table books rename to inventory;
-- Size
-- --------
...
alter table o1 add primary key(oid);
alter table o1 add foreign key(cid) references c1(cid);

select * 
from user_constraints
where table_name in ('C1','O1');


alter table c1 rename constraint SYS_C007266 to cust_pk;
alter table o1 rename constraint sys_c007267 to ord_pk;
alter table o1 rename constraint sys_c007268 to cust_fk;
...
drop table c1 cascade constraints;
