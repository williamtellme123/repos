...
-- BOOK
-- ------------------------------------------------
select regexp_substr('Mississippi','[a-z]') abc from dual; -- i think i
select regexp_substr('Mississippi','[a-z]', 4) abc from dual; -- s
select regexp_instr('MiSsIsSiPpI','[a-z]', 4, 2) abc from dual; -- s (position 6)
select regexp_substr('MiSsIsSiPpI','[a-z]', 4, 2, 'i') abc from dual; -- I

select regexp_substr('Mississippi','[a-z]{3}') from dual; --iss
select regexp_substr('MissiSsippi','[a-z]{3,4}') from dual; --issi
select regexp_substr('MissiSsippi','[a-z]{3,4}',1,2) from dual; -- sipp
select regexp_substr('Mississippi','[a-z]{3,4}',1,2) from dual; -- ssip

select regexp_substr('M i s s i s s i p p i','[ a-z]{3,4}',1,2) from dual; -- <sp>s i
select regexp_substr('abcdefghijklimnp','[a-z]{3,4}',1,2) from dual; --efgh

select regexp_replace('Mississippi','[a-z]','*',1,2,'i') from dual; -- M**********
select regexp_count('Mississippi','iss') from dual; -- 4
