...
-- -----------------------------------------------------------------
-- Question 4
-- How much longer until project completion: based on average time to move a device and how many devices still need to be moved 
-- NOTE:  Each device is moved one at a time,
--        there is no overlap in time.
--        If it takes an average of 2 hours to move a device and there are 5 more devices to move 
--        the total time to project completion is 2 * 5 = 10 hours
