...
-- -----------------------------------------------------------------------------
--    9. CREATE myself as a user
create user derrick identified by derrick;
grant all privileges to derrick;
