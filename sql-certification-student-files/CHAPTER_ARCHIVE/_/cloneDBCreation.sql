...
set echo on
spool C:\oraclexe\app\oracle\product\11.2.0\server\config\log\cloneDBCreation.log
...
shutdown immediate;
startup nomount pfile="C:\oraclexe\app\oracle\product\11.2.0\server\config\scripts\initXETemp.ora";
Create controlfile reuse set database "XE"
MAXINSTANCES 8
MAXLOGHISTORY 1
MAXLOGFILES 16
