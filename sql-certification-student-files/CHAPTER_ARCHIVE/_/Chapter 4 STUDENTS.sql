...
-- -----------------------------
            select customer# ID, firstname || ' ' || lastname as fullname
            from customers;
-- -----------------------------
...
-- -----------------------------
            select 100 + 25 from dual;
            select 100 + 25 from books;
...
select ((1248+984)/9)*(4.55+6.25) from dual;
...
-- -----------------------------           
            select title, category, retail from books where category='COMPUTER';
-- -----------------------------
...
--       Displays the physical address of the row
        ...
        -- and paste it here AAAE5TAABAAAK+JAAA 
...
select title, category from books order by 2,1 desc;
