...
drop table character_roles cascade constraints;
...
( 
  ...
  mid           integer,
  aid           integer,
  constraint mymovies_fk foreign key (mid) references movies(movie_id),
  constraint myactors_fk foreign key (aid) references actors(actor_id));
...
create user music1 identified by music;
