...
-- ---------------------------------------
-- g. Create a connection object in SQL Developer for
--       betty
--       carla
--       dana
...
-- ---------------------------------------
-- f. As Andy create synonym vw_my_cust for vw_cust
create synonym vw_my_cust for vw_cust;
...
--     1.    Drop Andy 
--     2.    Recreate Andy with 
--             privilege to connect 
--             use tablespace
--             create table with grant option
--             create public synonym with admin option
--             create synonym with grant option
...
-- -----------------------------------------------------------------------------------
-- c. As system Grant threes users
...
-- 7. As Andy
-- -----------------------------------------------------------------------------
-- a.  Create table people from customers



-- -----------------------------------------------------------------------------
-- b.  Create view vw_people for just first three columns of people



-- -----------------------------------------------------------------------------
-- c.  Create Public synonym vw_of_people for vw_people



-- -----------------------------------------------------------------------------
-- d.  Grant select vw_of_people to Betty 



-- -----------------------------------------------------------------------------
-- e.  Create table purchases from customers



-- -----------------------------------------------------------------------------
-- f.  Create view vw_purchases for just first three columns of purchase



-- -----------------------------------------------------------------------------
-- g. Create synonym vw_of_purchases



-- -----------------------------------------------------------------------------
-- h.  Grant select vw_of_purchases to Betty 
