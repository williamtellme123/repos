...
group by name;
  ...
  HAVING upper(lastname) = (select lastname from customers where lastname = 'GIANA');
...
CREATE TABLE invoices_revised2
(
    invoice_id     INTEGER,
    invoice_date   DATE,
    invoice_amt    NUMBER,
...
select count(*) from invoices_revised2;
