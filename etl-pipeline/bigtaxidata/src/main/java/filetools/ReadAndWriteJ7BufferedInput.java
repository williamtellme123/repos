...
public class ReadAndWriteJ7BufferedInput {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (
                ...
                InputStream fileInputStream = new BufferedInputStream(new FileInputStream("./bigtaxidata/src/main/resources/kitten.jpg"));
                FileOutputStream fileOutputStream = new FileOutputStream("./bigtaxidata/src/main/resources/kitten_copyj8.jpg")
