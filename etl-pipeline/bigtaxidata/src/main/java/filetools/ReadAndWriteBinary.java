...
public class ReadAndWriteBinary {
    public static void main(String[] args) throws IOException {
        ...
        try
        {
            ...
            fileInputStream = new FileInputStream("./bigtaxidata/src/main/resources/kitten.jpg");
            fileOutputStream = new FileOutputStream("./bigtaxidata/src/main/resources/kitten_copy.jpg");
            int data;
