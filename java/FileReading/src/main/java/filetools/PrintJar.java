 ...
 * @author Zemian Deng
 *
 * Just run "java filetools.PrintJar /path/to/my.jar" to see output
 * Print content manifest file of any jar file: version etc.
 *
 * Java 8
 *      filename
 *      .stream()
 ...
 *
 *      BufferedReader now comes with "lines()" method that also
 * allows streaming
 *
 *
 */
