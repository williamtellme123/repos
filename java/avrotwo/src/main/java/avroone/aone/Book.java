...
public class Book extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Book\",\"namespace\":\"avroone.aone\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":[\"int\",\"null\"]},{\"name\":\"category\",\"type\":[\"string\",\"null\"]}]}");
  ...
  public static avroone.aone.Book.Builder newBuilder() {
    return new avroone.aone.Book.Builder();
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Builder */
  public static avroone.aone.Book.Builder newBuilder(avroone.aone.Book.Builder other) {
    return new avroone.aone.Book.Builder(other);
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Book instance */
  public static avroone.aone.Book.Builder newBuilder(avroone.aone.Book other) {
    return new avroone.aone.Book.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Book>
    ...
    private Builder() {
      super(avroone.aone.Book.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avroone.aone.Book.Builder other) {
      super(other);
    ...
    private Builder(avroone.aone.Book other) {
            super(avroone.aone.Book.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public avroone.aone.Book.Builder setName(java.lang.CharSequence value) {
    ...
    public avroone.aone.Book.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public avroone.aone.Book.Builder setId(java.lang.Integer value) {
    ...
    public avroone.aone.Book.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'category' field */
    public avroone.aone.Book.Builder setCategory(java.lang.CharSequence value) {
    ...
    public avroone.aone.Book.Builder clearCategory() {
      category = null;
